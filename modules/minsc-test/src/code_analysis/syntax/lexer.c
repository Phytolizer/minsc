...
static TestTokenBuf get_tokens(void) {
    static const TestToken a[] = {
        {SYNTAX_KIND_WHITESPACE_TOKEN, str_lit(" ")},
        {SYNTAX_KIND_WHITESPACE_TOKEN, str_lit("  ")},
        {SYNTAX_KIND_WHITESPACE_TOKEN, str_lit("\r")},
        {SYNTAX_KIND_WHITESPACE_TOKEN, str_lit("\n")},
        {SYNTAX_KIND_WHITESPACE_TOKEN, str_lit("\r\n")},
        {SYNTAX_KIND_NUMBER_TOKEN, str_lit("1")},
        {SYNTAX_KIND_NUMBER_TOKEN, str_lit("123")},
        {SYNTAX_KIND_PLUS_TOKEN, str_lit("+")},
        {SYNTAX_KIND_MINUS_TOKEN, str_lit("-")},
        {SYNTAX_KIND_STAR_TOKEN, str_lit("*")},
        {SYNTAX_KIND_SLASH_TOKEN, str_lit("/")},
        {SYNTAX_KIND_BANG_TOKEN, str_lit("!")},
        {SYNTAX_KIND_EQUALS_TOKEN, str_lit("=")},
        {SYNTAX_KIND_AMPERSAND_AMPERSAND_TOKEN, str_lit("&&")},
        {SYNTAX_KIND_PIPE_PIPE_TOKEN, str_lit("||")},
        {SYNTAX_KIND_EQUALS_EQUALS_TOKEN, str_lit("==")},
        {SYNTAX_KIND_BANG_EQUALS_TOKEN, str_lit("!=")},
        {SYNTAX_KIND_OPEN_PARENTHESIS_TOKEN, str_lit("(")},
        {SYNTAX_KIND_CLOSE_PARENTHESIS_TOKEN, str_lit(")")},
        {SYNTAX_KIND_IDENTIFIER_TOKEN, str_lit("a")},
        {SYNTAX_KIND_IDENTIFIER_TOKEN, str_lit("abc")},
        {SYNTAX_KIND_FALSE_KEYWORD, str_lit("false")},
        {SYNTAX_KIND_TRUE_KEYWORD, str_lit("true")},
    };
